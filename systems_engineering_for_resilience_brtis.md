...
- System elements represented as nodes and edges (states and transitions)
- Capability: represents the system’s ability to achieve the desired effects.
- Complications to modeling resilience:
    - Multiple discrete adverse event scenarios
    - Multiple adverse events affecting system over period of interest
